    ...
    <GuestLayout>
        <div class="bg-gray-50 font-sans">
            <div class="container mx-auto p-4 md:p-8 w-full max-w-7xl">
                ...
                <header class="mb-8 p-4 bg-white rounded-lg shadow-lg flex justify-between items-center relative">
                    ...
                    <nav class="hidden md:flex">
                        <ul class="flex items-center space-x-6 lg:space-x-8 text-gray-600 font-semibold">
                            <li><a href="#" class="hover:text-blue-600 transition-colors">Carregdores</a></li>
                            <li><a href="#" class="hover:text-blue-600 transition-colors">Fones de Ouvido</a></li>
                            <li><a href="#" class="hover:text-blue-600 transition-colors">Caixas de Som</a></li>
                            <li><a href="#" class="hover:text-blue-600 transition-colors">Informática</a></li>
                            <li><a href="#" class="hover:text-blue-600 transition-colors">Copos Térmicos</a></li>
                        </ul>
                    </nav>
                ...
                <!-- Grid de Produtos -->
                <main>
                    <h2 class="text-3xl font-bold text-gray-800 mb-8">Nossos Produtos</h2>
